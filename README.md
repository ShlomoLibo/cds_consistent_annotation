...
<img src="reports/examples/human_false_annotation.png" alt="human">

Example generated by aligning CDS pieces from different species (PLA2G2 family),  to human's PLAG2F gene region.  
No other CDS aligns to the marked CDS piece in human, therefore it's likely a false annotation in NCBI's RefSeq. 
